...
function show7() {
  ...
  document.getElementById("e_e").hidden = false;
...
function show8() {
  document.getElementById("e_e").hidden = true;
  document.getElementById("c_c").hidden = false;
...
function show9() {
  document.getElementById("c_c").hidden = true;
